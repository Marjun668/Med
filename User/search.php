                        ...
                        <form action="search.php" method="GET" id="filterForm">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="sort" class="form-select" onchange="document.getElementById('filterForm').submit()">
                                    ...
                                    <option value="price_high" <?php echo $sortBy == 'price_high' ? 'selected' : ''; ?>>Highest Price</option>
                                    <option value="pharmacy" <?php echo $sortBy == 'pharmacy' ? 'selected' : ''; ?>>Pharmacy Name</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="type[]" value="brand" id="brandCheck" 
                                        <?php echo in_array('brand', $selectedTypes) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="brandCheck">Brand</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="type[]" value="generic" id="genericCheck"
                                        <?php echo in_array('generic', $selectedTypes) ? 'checked' : ''; ?>>
                            ...
                            <div class="mb-3">
                                <label for="priceRange" class="form-label fw-bold">Maximum Price: PHP <span id="priceValue"><?php echo $maxPrice; ?></span></label>
                                ...
                                <div class="mt-2">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-secondary" id="applyCustomPrice">Apply</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex gap-2 mb-3">
                                ...
                                <a href="search.php<?php echo !empty($searchQuery) ? '?q=' . urlencode($searchQuery) : ''; ?>" class="btn btn-outline-secondary" id="resetFilters">
                    ...
                    ?>
                        <div class="alert alert-info">
                            ...
                            <?php if ($initialCount == 0): ?>
                                <p><strong>Suggestion:</strong> Try a different search term. No medications matched "<?php echo $searchQuery; ?>".</p>
                            ...
                            <a href="search.php<?php echo !empty($searchQuery) ? '?q=' . urlencode($searchQuery) : ''; ?>" class="btn btn-outline-primary mt-2">
                        ...
                        ?>
                            <div class="card mb-4 shadow-sm">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h4 class="card-title"><?php echo sanitize($medication['name']); ?> <?php echo sanitize($medication['dosage'] . ' ' . $medication['form']); ?></h4>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="row">
                                            <?php 
                                            // Show up to 3 pharmacies in the list
                                            $displayCount = min(3, count($prices));
                                            for($i = 0; $i < $displayCount; $i++): 
                                            ?>
                                                <div class="col-md-4 mb-2">
                                                    <div class="d-flex align-items-center">
                                                        <i class="fas fa-store text-primary me-2"></i>
                                                        <span><?php echo sanitize($prices[$i]['pharmacy_name']); ?> - <?php echo formatPrice($prices[$i]['price']); ?></span>
                                                    </div>
                                                </div>
                                            <?php endfor; ?>
                                            
                                            <?php if(count($prices) > 3): ?>
                                                <div class="col-md-4 mb-2">
                                                    <a href="details.php?id=<?php echo $medication['id']; ?>" class="text-primary">
                                                        <i class="fas fa-plus-circle me-1"></i> <?php echo count($prices) - 3; ?> more
                                                    </a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
