        ...
        <div class="col-md-10">
            <div class="alert alert-info d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <strong>Create an account or log in</strong> to save your favorite medications and get personalized recommendations.
                </div>
                <div>
                ...
                <div class="card-body p-4">
                    <form action="search.php" method="GET" class="search-form">
                        <div class="input-group input-group-lg">
                            <input type="text" class="form-control" name="q" placeholder="Enter medication name (min. 3 characters)" required minlength="3">
                    ...
                    <div class="card h-100 hover-shadow">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                <br><small class="text-muted">Generic: <?php echo sanitize($medication['generic_name']); ?></small>
                                <?php endif; ?>
                            </p>
                            <a href="search.php?q=<?php echo urlencode($medication['name']); ?>" class="btn btn-outline-primary">Compare Prices</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
                ...
                <div class="col">
                    <div class="card text-center h-100">
                        <div class="card-body">
                            ...
                            <a href="search.php?category=<?php echo urlencode($category); ?>" class="stretched-link"></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
